        ...
        <form action="#">
          ...
          <div className="f-form-group">
            ...
            <div className="form-input">
              ...
              <button className="ouline-btn">직접 입력</button>
            </div>
          </div>
          <div className="f-form-group">
            <label htmlFor="name">아이디</label>
          ...
          <div className="f-form-group">
            <label htmlFor="name">아이디</label>
            <div className="form-input">
              <input type="date" placeholder="hong***" />
            </div>
          </div>
          <div className="f-form-group">
            <label htmlFor="name">아이디</label>
            <div className="form-input">
              ...
              <div className="form-check">
                <input
                  ...
                  value="option3"
                />
                <label htmlFor="exampleRadios3" className="check-label">
                  여성
                </label>
              </div>
            </div>
          ...
          <div className="f-form-group">
            <label htmlFor="name">sms 및 email 수신동의 (이벤트정보) <span>*</span></label>
            <div className="form-input">
              <div className="form-check">
                <input
                  className="form-check-input"
          ...
          <div className="form-btn">
            ...
            <button className="ouline-btn red-btn">회원 등록</button>

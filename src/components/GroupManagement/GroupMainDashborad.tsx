...
import MemberListTable from "../MemberManagement/MemberListTable";
import TablePagination from "../MemberManagement/TablePagination";

const GroupMainDashborad = () => {
    return (
...
export default GroupMainDashborad;